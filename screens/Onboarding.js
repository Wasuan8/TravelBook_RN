        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flex: 1, alignContent: 'center', justifyContent: 'center' }}>
                <View style={{ alignItems: 'center', marginHorizontal: SIZES.padding }}>
                    ...
                    <Text
                        style={{ color: COLORS.gray, marginTop: SIZES.padding, textAlign: 'center', ...FONTS.body3 }}
                    >Easy solution to buy tickets for your travel, business trips, transportation, lodging and culinary.

                    </Text>
                    <TouchableOpacity
                        style={[styles.shadow, { marginTop: SIZES.padding * 2, width: "90%", height: 50, alignItems: 'center', justifyContent: 'center' }]}
